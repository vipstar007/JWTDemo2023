...
import com.example.athenticationdemo.token.TokenRepository;
import com.example.athenticationdemo.user.User;
import com.example.athenticationdemo.user.UserRepository;
...
import com.example.athenticationdemo.token.TokenType;
    ...
    public void refreshToken(
        ...
        if (userEmail != null) {
            ...
            if (jwtService.isTokenValid(refreshToken, user)) {
                var accessToken = jwtService.generateJwtToken(user.getUsername(),jwtService.privateKey());
                revokeAllUserTokens(user);
